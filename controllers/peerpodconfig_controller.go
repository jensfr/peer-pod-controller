...
/*
  cloudProvderName needs to be verified against validCloudProviders by caller
*/
...
func (r *PeerPodConfigReconciler) createWebhook() appsv1.Deployment {
	var nrReplicas int32 = 2
		...
		Spec: appsv1.DeploymentSpec{
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					Containers: []corev1.Container{
						{
							Name:         "openshift-sandboxed-containers-peerpod-webhook",
							Image:        "quay.io/confidential-containers/peerpod-webhook",
							Command:      []string{"./main"},
							EnvFrom:      nil,
							Env:          nil,
							VolumeMounts: nil,
